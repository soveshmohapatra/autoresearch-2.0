...
Enhanced with: Architecture variants, Optimizer zoo, Checkpointing.

Usage: uv run python train.py [--depth 8] [--aspect-ratio 64] [--batch-size 64] ...
       uv run python optuna_search.py   # Bayesian hyperparameter search
       uv run python agent.py           # autonomous Claude agent loop
"""
...
USE_PRENORM   = True        # Pre-norm residual stream (default: post-norm)
